...
namespace Omelettes\Quantum\Session\SaveHandler;

use Zend\Session\SaveHandler\DbTableGateway as ZendSaveHandler;

class DbTableGateway extends ZendSaveHandler
{
